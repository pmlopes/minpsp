Name "Old School Library DevPak"

SetCompressor /SOLID lzma

# Defines
!define UNIX_NAME oslib
!define VERSION 2.10
...
Section -Main SEC0000
    ...
    Quit
    # check for internal dependencies
    ReadRegStr $1 HKLM "SOFTWARE\PSP DevKit\devpak" libmikmod
    StrCmp $1 '3.1.11' +3 +1
    MessageBox MB_OK|MB_ICONSTOP 'Required devpak libmikmod (3.1.11) missing'
    Quit
    # install
    SetOutPath $0
    SetOverwrite on
