...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
    ...
    shape->begin();
    shape->addVertex(Vector2(-1.0, 0));
    shape->addVertex(Vector2(0, 1.0));
    shape->addVertex(Vector2(1.0, 0));
    shape->addVertex(Vector2(0, -1.0));
    shape->finish();
	...
	//pressure body
	pb = new PressureBody(ball, 1.0f, 40.0f, 10.0f, 1.0f, 300.0f, 20.0f, Vector2(0, -10), 0, Vector2(0.5f,0.5f),false);
