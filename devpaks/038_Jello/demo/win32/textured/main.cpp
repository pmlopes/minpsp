...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	shape1->begin();
    shape1->addVertex(Vector2(-20, -1));
    shape1->addVertex(Vector2(-20, 1));
    shape1->addVertex(Vector2(20, 1));
    shape1->addVertex(Vector2(20, -1));
    shape1->finish();

	bod = new Body(shape1,0,Vector2(0, -19),0,Vector2::One,false);
	mWorld->addBody(bod);

	shape = new ClosedShape();
    shape->begin();
    shape->addVertex(Vector2(-1.0f, 0.0f));
    shape->addVertex(Vector2(0.0f, 1.0f));
    shape->addVertex(Vector2(1.0f, 0.0f));
    shape->addVertex(Vector2(0.0f, -1.0f));
    shape->finish();
	...
	//pressure body
	pb = new PressureBody(ball, 1.0f, 50.0f, 10.0f, 1.0f, 300.0f, 20.0f, Vector2(0, -10), 0, Vector2(0.5f,0.5f),false);
